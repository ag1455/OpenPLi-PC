...
if [ "$release" = "14.04" ]; then
	...
	cp patches/patch-7df871bb-to-PC.patch $PKG
	cp patches/ubuntu-14.04.patch $PKG
	cd $PKG
	patch -p1 < patch-7df871bb-to-PC.patch
	...
	echo "********************************************************"
	export CXX=/usr/bin/g++-7
	cp patches/patch-7df871bb-to-PC-sigc2.patch $PKG
	cd $PKG
	patch -p1 < patch-7df871bb-to-PC-sigc2.patch
