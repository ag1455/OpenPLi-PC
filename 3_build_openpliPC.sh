...
if [ "$release" = "14.04" ]; then
	...
	cp patches/patch-bac348b6-to-PC.patch $PKG
	cp patches/ubuntu-14.04.patch $PKG
	cd $PKG
	patch -p1 < patch-bac348b6-to-PC.patch
	...
	echo "********************************************************"
	export CXX=/usr/bin/g++-7
	cp patches/patch-bac348b6-to-PC-sigc2.patch $PKG
	cd $PKG
	patch -p1 < patch-bac348b6-to-PC-sigc2.patch
