...
class dirSelectDlg1(Screen): # 90,140
	skin = """
		<screen name="dirSelectDlg1" position="center,center" size="560,360">
			...
			<widget name="ButtonGreen" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/navibar/images/button_green.png" position="30,270" zPosition="10" size="35,25" transparent="1" alphatest="on" />
			<widget name="ButtonRedtext" position="70,300" size="460,25" halign="left" zPosition="10" font="Regular;21" transparent="1" />
			<widget name="ButtonRed" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/navibar/images/button_red.png" position="30,300" zPosition="10" size="35,25" transparent="1" alphatest="on" />
			<widget name="ButtonOKtext" position="70,330" size="460,25" halign="left" zPosition="10" font="Regular;21" transparent="1" />
			<widget name="ButtonOK" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/navibar/images/button_ok.png" position="30,330" zPosition="10" size="35,35" transparent="1" alphatest="on" />
		</screen>"""

	def __init__(self, session, currDir, showFilesBoolean):
		self.skin = dirSelectDlg1.skin
