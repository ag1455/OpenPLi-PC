...
def executebuiltin(function):
    ...
    if not "Container.Update" in function:
        ...
        n3 = url.find("?", 0)
        arg3 = url[n3:]
        arg1 = sys.argv[0].replace("plugin://","/usr/lib/enigma2/python/Plugins/Extensions/KodiLite/" + ADDONCAT + "/") + "default.py"
        arg2 = sys.argv[1]  
...
def translatePath(url, asURL=False):
	...
	xurl = url
        ...
        if "special://home/addons/" in url:
            url = url.replace("special://home/addons/", "/usr/lib/enigma2/python/Plugins/Extensions/KodiLite/" + ADDONCAT + "/")
