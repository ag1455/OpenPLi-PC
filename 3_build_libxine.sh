...
# This is hg 1.2.10
hg clone -r14848 http://hg.code.sf.net/p/xine/xine-lib-1.2 $PKG

if [ -d "$PKG" ]; then
	echo "-----------------------------------------"
	echo "      head now on 14848:25ae0846e9a6"
	echo "-----------------------------------------"
	cp -fv patches/xine-lib-1.2-14848:25ae0846e9a6.patch $PKG
else
	echo "-----------------------------------------"
...
cd $PKG
patch -p1 < xine-lib-1.2-14848:25ae0846e9a6.patch
echo "-----------------------------------------"
