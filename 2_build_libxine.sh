...
# This is hg 1.2.10
hg clone -r 14803 http://hg.code.sf.net/p/xine/xine-lib-1.2 $PKG

if [ -d "$PKG" ]; then
	echo "-----------------------------------------"
	echo "      head now on 14803:f4b85ab2dd89"
	echo "-----------------------------------------"
	cp patches/xine-lib-1.2-14803:f4b85ab2dd89.patch $PKG
else
	echo "-----------------------------------------"
...
cd $PKG
patch -p1 < xine-lib-1.2-14803:f4b85ab2dd89.patch
echo "-----------------------------------------"
