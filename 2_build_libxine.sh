...
# This is hg 1.2.10
hg clone -r 14751 http://hg.code.sf.net/p/xine/xine-lib-1.2 $PKG

if [ -d "$PKG" ]; then
	echo "-----------------------------------------"
	echo "      head now on 14751:f6a9466fb16b"
	echo "-----------------------------------------"
	cp patches/xine-lib-1.2-14751:f6a9466fb16b.patch $PKG
else
	echo "-----------------------------------------"
...
cd $PKG
patch -p1 < xine-lib-1.2-14751:f6a9466fb16b.patch
echo "-----------------------------------------"
