...
# This is hg 1.2.10
hg clone -r 14753 http://hg.code.sf.net/p/xine/xine-lib-1.2 $PKG

if [ -d "$PKG" ]; then
	echo "-----------------------------------------"
	echo "      head now on 14753:67127e5dab4f"
	echo "-----------------------------------------"
	cp patches/xine-lib-1.2-14753:67127e5dab4f.patch $PKG
else
	echo "-----------------------------------------"
...
cd $PKG
patch -p1 < xine-lib-1.2-14753:67127e5dab4f.patch
echo "-----------------------------------------"
